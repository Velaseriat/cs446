...
class SoldiersControllerTest < ActionController::TestCase
  ...
  test "should create soldier" do
    assert_difference('Soldier.count') do
      post :create, soldier: { atk: @soldier.atk, def: @soldier.def, first_name: @soldier.first_name, last_name: @soldier.last_name }
    end
  ...
  test "should update soldier" do
    patch :update, id: @soldier, soldier: { atk: @soldier.atk, def: @soldier.def, first_name: @soldier.first_name, last_name: @soldier.last_name }
    assert_redirected_to soldier_path(assigns(:soldier))
  end
